 ...
 *
 * Use OpenCL to perform a quadratic regression on a 4M = 4,194,304 x-y pair dataset and
 * obtain the equation of a parabola y = Qx2 + Lx + C that best fits the data points.
 *
 */
...
#ifdef CSV
	fprintf( stderr, "%8d , %6d , %10.2lf , %7.1f , %7.1f , %7.1f \n",
